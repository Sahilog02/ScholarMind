...
with st.form("claim_form"):
    ...
    min_evidence = st.slider("Minimum strong-evidence papers before stopping", 2, 8, 2)
...
if provider == "openrouter" and not os.getenv("OPENROUTER_API_KEY"):
    st.warning("No OPENROUTER_API_KEY found. Get a free key at https://openrouter.ai/keys and add it to your .env file.")
    st.stop()

if provider == "gemini" and not os.getenv("GEMINI_API_KEY"):
    st.warning("No GEMINI_API_KEY found. Get a free key at https://aistudio.google.com/apikey and add it to your .env file.")
    st.stop()
